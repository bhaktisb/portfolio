  ...
  return (
    <div className="w-full flex flex-col md:flex-row items-center md:justify-between">
      ...
      <div className="w-full md:w-[50%] pl-4 pt-0">
        ...
        >
          Passionate MERN stack developer and machine learning enthusiast, creating innovative solutions that blend technology and user experience.
        </motion.p>
        <button className="bg-[#ffdf00] w-[200px] rounded-md font-medium my-6 mx-auto px-4 py-3 text-black">Go to MyTechStack</button>
